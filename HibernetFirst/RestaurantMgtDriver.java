	...
	public static void main(String args[])
	{
		...
		do {
			...
			case 2:
				...
				readRestById(session);
				break;		

			case 3:
				System.out.println("Update By id Data");
...
//			session.close();
		...
		private static void readRestById(Session session)
		{
			...
			RestaurantMgt restFromDb=session.get(RestaurantMgt.class, restaurantId);
			if(restFromDb != null)
			{
...
//				session.close();
		...
		private static RestaurantMgt getRestaurantName() {
			RestaurantMgt restObj=new RestaurantMgt();
